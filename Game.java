...
public class Game {
	...
	public void play(IDie die) {
		...
		while (this.notOver()) {
			int roll = die.roll();
			System.out.println(players.peek() + " rolls " + roll + ":  " + this);
	...
	public void movePlayer(int roll) {
        Player currentPlayer =  players.remove(); //remove player from the queue
        players.add(currentPlayer); //add current player to the back of queue
	...
	/**
	 * Make the specified player lose the game.
	 * @param currentPlayer the current player
	 */
	public void makePlayerLose(Player currentPlayer) {
